...
Form
{
	...
	Group
	{
		...
		CheckBox 
		{ 
			name: "autoReport";	label: qsTr("Auto Report")
		
			title: qsTr("Verbosity Level")
			RadioButton { value: "low";	label: qsTr("Low verbosity")		}
			RadioButton { value: "medium";	label: qsTr("Medium verbosity")	}
			RadioButton { value: "high"; label: qsTr("High verbosity")		}
		}
	}
