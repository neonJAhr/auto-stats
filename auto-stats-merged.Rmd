...
The data can be visualized with the help of a raincloud plot (ref to raincloud plot paper). This allows an immediate intuitive assessment of whether the groups differ, and whether the data in each group are approximately normally distributed.
