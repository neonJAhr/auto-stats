...
VISUALLY CONFIRMATION OF EQUAL VARIANCE BETWEEN DATA SETS & OUTLIERS</span>
...
<span style="color: red;">Paragraph explaining the concept of normality testing.</span>

### Actual Test

<span style="color: red;">Datasets: Is it possible to have a dataset on which one can test all types of statistical tests? Can you reasonably run an independent and paired t test on the same dataset?</span>
