...
# Code chunk needs to be before any reference to the statistic itself.
if (outlier_test == TRUE & levTest$`Pr(>F)`[1] <= 0.05 & sw_test$p.value >= 0.05) {
  # ttest <- t.test(data = data, mean_NEO~Rotation, var.equal = TRUE, alternative = "two.tailed")
...
ISSUE: This method of output requires there to be a object called ttest. 
