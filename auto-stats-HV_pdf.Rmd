...
\textcolor{blue}{Red font is meant to show missing areas as reminders for me to improve on.}
...
# Tables
  apa_table(apa_t$table, caption = "Independent t-test of the moon on outbursts")
  apa_table(apa_welch$table, caption = "Welch's t-test of the moon on outbursts")
...
<span style="color: red;">Cannot just round, needs instead some evaluation like "if p < 0.001, print that"</span>

##### Misconceptions on Hypothesis Testing; ONLY FOR HV

Unfortunately, it is easy to misconceptions about the p-value. In order to avoid making incorrect assertions, take a look at the following statements that are all incorrect: 
